...
public class TabPopupMenu extends JPopupMenu {
    ...
    private void create() {
        ...
        closeActiveTab = new JMenuItem(Config.strings.closeTab);
        closeActiveTab.addActionListener(e -> context.disposeActiveTab());
        add(closeActiveTab);

        //Configure saveActiveTab:
        saveActiveTab = new JMenuItem(Config.strings.saveTab);
        saveActiveTab.addActionListener(e -> context.saveActiveTab());
        add(saveActiveTab);

        //Construct showInExplorer:
        showInExplorer = new JMenuItem(Config.strings.showTabInExplorer);
